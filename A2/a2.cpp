...
int main() {
  ...
  string fileName1 = "merge_random.txt";
  string fileName2 = "merge_reversed.txt";
  string fileName3 = "merge_nearly.txt";

  string fileName4 = "hybrid_random.txt";
  string fileName5 = "hybrid_reversed.txt";
  string fileName6 = "hybrid_nearly.txt";
  ...
  for (int size = 500; size <= 100000; size += (size < 10000 ? 100 : 500)) {
